 ...
 */
var l$1=objectAssign$1;if("function"===typeof Symbol&&Symbol.for){var w$1=Symbol.for;w$1("react.element");w$1("react.portal");w$1("react.fragment");w$1("react.strict_mode");w$1("react.profiler");w$1("react.provider");w$1("react.context");w$1("react.forward_ref");w$1("react.suspense");w$1("react.memo");w$1("react.lazy");}function z$1(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}
...
function D$2(){}D$2.prototype=C$1.prototype;function E$2(a,b,c){this.props=a;this.context=b;this.refs=B$2;this.updater=c||A$1;}var F$2=E$2.prototype=new D$2;F$2.constructor=E$2;l$1(F$2,C$1.prototype);F$2.isPureReactComponent=!0;
...
function ReactButton(props) {
    return (react$1.exports.createElement("input", { type: "button", value: props.text, onClick: (_) => props.onClick() }));
}
var Main = (context) => {
    return {
        $controls: {
